...
def create_app():
  ...
  app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:@localhost/epl_02_db'
  # app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@localhost/premier_league_db'
